...
`Vector#int8()`:: Creates an `INTEGER8` vector (`Int8Vector`)
`Vector#int16()`:: Creates an `INTEGER16` vector (`Int16Vector`)
`Vector#int32()`:: Creates an `INTEGER32` vector (`Int32Vector`)
`Vector#int64()`:: Creates an `INTEGER` vector (`Int64Vector`)
`Vector#float32()`:: Creates an `FLOAT32` vector (`Float32Vector`)
`Vector#float64()`:: Creates an `FLOAT` vector (`Float64Vector`)
