...
image:https://img.shields.io/maven-central/v/org.neo4j/neo4j-jdbc?logo=apache-maven&style=flat-squareg[link=https://mvnrepository.com/artifact/org.neo4j/neo4j-jdbc]
