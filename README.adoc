...
:neo4j-jdbc-version: 3.5.2

ifndef::env-docs[]
You can find the full documentation at: http://neo4j-contrib.github.io/neo4j-jdbc/
endif::env-docs[]

*This is an JDBC driver for Neo4j which supports Cypher over JDBC*.
...
|usebookmarks |true/false |If specified disables the bookmarkss
|===
