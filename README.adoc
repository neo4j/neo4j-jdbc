...
* every kind of Neo4J server exposing services through the HTTP protocol (2.X+)
...
* You can also set comma separated parameters in the URL for authentication, debug mode and ssl encryption, e.g. jdbc:neo4j:bolt://localhost/?user=neo4j,password=neo4j,debug=true,noSsl,flatten=-1
