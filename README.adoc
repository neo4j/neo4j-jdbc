...
Using this driver you will be able to interact with a Neo4J database using also the new BOLT protocol.
...
feedback and suggestions but don't use this in a production environment (yet).
