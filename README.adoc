...
|https://github.com/neo4j-contrib/neo4j-jdbc/releases/tag/4.0.1[4.0.1]
| 3.5.x - 4.x
|4.0.1
|11
|http, bolt, bolt+routing
...
|refreshsession |false/true |If specified creates a new session for each statement
|===
