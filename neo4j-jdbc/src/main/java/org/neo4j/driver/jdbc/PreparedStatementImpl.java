...
final class PreparedStatementImpl extends StatementImpl implements PreparedStatement {
	...
	public ResultSet executeQuery(String sql) throws SQLException {
		throw newIllegalMethodInvokation();
	}
	...
	public void setNull(int parameterIndex, int ignored) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.NULL);
	}
	...
	public void setString(int parameterIndex, String string) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(string));
	}
	...
	public void setBytes(int parameterIndex, byte[] bytes) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(bytes));
	}
	...
	public void setDate(int parameterIndex, Date date) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(date.toLocalDate()));
	}
	...
	public void setTime(int parameterIndex, Time time) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(time.toLocalTime()));
	}
	...
	public void setTimestamp(int parameterIndex, Timestamp timestamp) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(timestamp.toLocalDateTime()));
	}
	...
	public void setAsciiStream(int parameterIndex, InputStream inputStream, int length) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(new String(bytes, StandardCharsets.US_ASCII)));
	}
	...
	public void setObject(int parameterIndex, Object object) throws SQLException {
		...
		if (object instanceof Date date) {
			...
			this.parameters.put(String.valueOf(parameterIndex), value);
		}
	}
	...
	public void setCharacterStream(int parameterIndex, Reader reader, int length) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(new String(charBuffer)));
	}
	...
	public void setDate(int parameterIndex, Date date, Calendar cal) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(zonedDateTime));
	}
	...
	public void setTime(int parameterIndex, Time time, Calendar cal) throws SQLException {
		...
		this.parameters.put(String.valueOf(parameterIndex), Values.value(offsetTime));
	}
	...
	private SQLException newIllegalMethodInvokation() throws SQLException {
