...
public final class InternalBoltRecord extends InternalMapAccessorWithDefaultValue implements BoltRecord {
	...
	public InternalBoltRecord(List<String> keys, Value[] values) {
		this.keys = keys;
		this.values = values;
	}
	...
	public boolean equals(Object other) {
		...
		else if (other instanceof BoltRecord otherRecord) {
			var size = size();
	...
	public String toString() {
		return String.format("Record<%s>", Format.formatPairs(asMap(Values.ofValue())));
	}
