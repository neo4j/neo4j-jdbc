 ...
 */
package org.neo4j.driver.jdbc.internal.bolt.internal.messaging;
...
public interface MessageFormat {
	...
	/**
	 * Enables datetime in UTC if supported by the given message format. This is only for
	 * use with formats that support multiple modes.
	 * <p>
	 * This only takes effect on subsequent writer and reader creation via
	 * {@link #newWriter(PackOutput)} and {@link #newReader(PackInput)}.
	 */
