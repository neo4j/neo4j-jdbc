 ...
 * @since 6.0.0
 */
public sealed interface Neo4jConnection extends Connection, Neo4jMetadataWriter<Neo4jConnection> permits ConnectionImpl {
	 ...
	 * of time for which the connection may remain idle (see the linked documentation
