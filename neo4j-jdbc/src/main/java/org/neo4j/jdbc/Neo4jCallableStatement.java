...
public abstract class Neo4jCallableStatement implements java.sql.CallableStatement {
	...
	@Override public Neo4jArray getArray(int parameterIndex) throws SQLException {
		throw ExceptionBuilder.buildUnsupportedOperationException();
	}
	...
	@Override public Neo4jArray getArray(String parameterName) throws SQLException {
		throw ExceptionBuilder.buildUnsupportedOperationException();
	}
