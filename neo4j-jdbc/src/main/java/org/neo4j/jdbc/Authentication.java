...
/**
 * Represents an authentication provided by an {@link AuthenticationProvider} to be used
 * with the {@link AuthenticationManager}. This interface represents the abstract notion
 * of a principal, which may be identified by a username and password, a token or other
 * means.
 *
 * @author Michael J. Simons
 */
public sealed interface Authentication
		permits DisabledAuthentication, TokenAuthentication, UsernamePasswordAuthentication {
