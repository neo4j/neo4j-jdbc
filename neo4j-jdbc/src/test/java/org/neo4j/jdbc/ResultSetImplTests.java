...
class ResultSetImplTests {
	...
	// void shouldProcessValueOnGetString(Value value, VerificationLogic<String>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getString(INDEX) :
	// this.resultSet.getString(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetBoolean(Value value, VerificationLogic<Boolean>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getBoolean(INDEX) :
	// this.resultSet.getBoolean(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetByte(Value value, VerificationLogic<Byte>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getByte(INDEX) :
	// this.resultSet.getByte(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetShort(Value value, VerificationLogic<Short>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getShort(INDEX) :
	// this.resultSet.getShort(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetInt(Value value, VerificationLogic<Integer>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getInt(INDEX) :
	// this.resultSet.getInt(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetLong(Value value, VerificationLogic<Long>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getLong(INDEX) :
	// this.resultSet.getLong(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetFloat(Value value, VerificationLogic<Float>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getFloat(INDEX) :
	// this.resultSet.getFloat(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetDouble(Value value, VerificationLogic<Double>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getDouble(INDEX) :
	// this.resultSet.getDouble(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetBytes(Value value, VerificationLogic<byte[]>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getBytes(INDEX) :
	// this.resultSet.getBytes(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetDate(Value value, VerificationLogic<Date>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getDate(INDEX) :
	// this.resultSet.getDate(LABEL));
	// }
	//
	...
	// // date handling
	// Arguments
	// .of(Values.value(LocalDate.of(2023, 1, 1)),
	// Named.<VerificationLogic<Date>>of("verify returns Date",
	// supplier -> assertThat(supplier.get()).isEqualTo(Date.valueOf(LocalDate.of(2023, 1,
	// 1))))),
	// // null handling
	// Arguments.of(Values.NULL,
	...
	// Named.<VerificationLogic<Date>>of("verify throws exception",
	// supplier -> assertThatThrownBy(supplier::get).isInstanceOf(SQLException.class))),
	// Arguments.of(Values.value(LocalDateTime.of(LocalDate.of(2022, 12, 4),
	// LocalTime.of(21, 21))),
	// Named.<VerificationLogic<Date>>of("verify returns Date",
	...
	// void shouldProcessValueOnGetDateWithCalendar(Value value, VerificationLogic<Date>
	// verificationLogic,
	...
	// var zonedDateTime = ZonedDateTime.of(2023, 1, 1, 1, 1, 1, 1,
	// ZoneId.systemDefault());
	// return Stream.of(
	// // date handling
	// Arguments.of(Values.value(zonedDateTime), Named.<VerificationLogic<Date>>of("verify
	// returns Date",
	// supplier ->
	// assertThat(supplier.get()).isEqualTo(Date.valueOf(zonedDateTime.toLocalDate())))),
	// // null handling
	// Arguments.of(Values.NULL,
	// Named.<VerificationLogic<Date>>of("verify returns null",
	// supplier -> assertThat(supplier.get()).isNull())),
	...
	// void shouldProcessValueOnGetTime(Value value, VerificationLogic<Time>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getTime(INDEX) :
	// this.resultSet.getTime(LABEL));
	// }
	//
	...
	// supplier -> assertThat(supplier.get()).isEqualTo(Time.valueOf(LocalTime.of(1,
	// 1))))),
	// // null handling
	// Arguments.of(Values.NULL,
	...
	// supplier -> assertThat(supplier.get()).isEqualTo(Time.valueOf(LocalTime.of(1,
	// 1))))),
	// Arguments.of(Values.value(ZonedDateTime.of(2023, 9, 21, 1, 1, 0, 0,
	...
	// void shouldProcessValueOnGetTimeWithCalendar(Value value, VerificationLogic<Time>
	// verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	// verificationLogic
	// .run(() -> indexAccess ? this.resultSet.getTime(INDEX, cal) :
	// this.resultSet.getTime(LABEL, cal));
	// }
	//
	...
	// return Stream.of(
	// // date handling
	// Arguments.of(Values.value(zonedDateTime), Named.<VerificationLogic<Time>>of("verify
	// returns Time",
	// supplier ->
	// assertThat(supplier.get()).isEqualTo(Time.valueOf(zonedDateTime.toLocalTime())))),
	// // null handling
	// Arguments.of(Values.NULL,
	// Named.<VerificationLogic<Time>>of("verify returns null",
	// supplier -> assertThat(supplier.get()).isNull())),
	...
	// void shouldProcessValueOnGetTimestamp(Value value, VerificationLogic<Timestamp>
	// verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	// // when & then
	// verificationLogic
	// .run(() -> indexAccess ? this.resultSet.getTimestamp(INDEX) :
	// this.resultSet.getTimestamp(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetTimestampWithCalendar(Value value,
	// VerificationLogic<Timestamp> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	// this.resultSet.next();
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getTimestamp(INDEX,
	// Calendar.getInstance())
	...
	// void shouldProcessValueOnGetCharacterStream(Value value, VerificationLogic<Reader>
	// verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	// var value = new
	// BufferedReader(supplier.get()).lines().collect(Collectors.joining());
	...
	// void shouldProcessValueOnGetBigDecimal(Value value, VerificationLogic<BigDecimal>
	// verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	// // when & then
	// verificationLogic
	// .run(() -> indexAccess ? this.resultSet.getBigDecimal(INDEX) :
	// this.resultSet.getBigDecimal(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetAsciiStream(Value value, VerificationLogic<InputStream>
	// verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	// // when & then
	// verificationLogic
	// .run(() -> indexAccess ? this.resultSet.getAsciiStream(INDEX) :
	// this.resultSet.getAsciiStream(LABEL));
	// }
	//
	...
	// void shouldProcessValueOnGetBinaryStream(Value value,
	// VerificationLogic<InputStream> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	// this.resultSet.next();
	...
	// void shouldProcessValueOnGetObject(Value value, VerificationLogic<Object>
	// verificationLogic, boolean indexAccess)
	// throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, 0);
	...
	//
	// // when & then
	// verificationLogic.run(() -> indexAccess ? this.resultSet.getObject(INDEX) :
	// this.resultSet.getObject(LABEL));
	// }
	//
	...
	// Named.<VerificationLogic<Object>>of(
	// "verify returns boolean", supplier ->
	...
	// .of(Arguments.of(Values.value("0"), Named.<VerificationLogic<Object>>of("verify
	// returns string '0'",
	// supplier -> assertThat(supplier.get()).isEqualTo("0"))));
	//
	// var integerStream = Stream.<Number>of(Integer.MIN_VALUE, Integer.MAX_VALUE,
	// Long.MIN_VALUE, Long.MAX_VALUE)
	// .map(value -> Arguments.of(Values.value(value),
	// Named.<VerificationLogic<Object>>of(
	// "verify returns long", supplier ->
	// assertThat(supplier.get()).isEqualTo(value.longValue()))));
	//
	// var floatStream = Stream.<Number>of(Float.MIN_VALUE, Float.MAX_VALUE,
	...
	// .of(Arguments.of(Values.NULL, Named.<VerificationLogic<Object>>of("verify returns
	// null",
	// supplier -> assertThat(supplier.get()).isNull())));
	//
	// var listStream = Stream.of(List.of(1L, 2L, 3L, 4L, 5L))
	// .flatMap(list -> Stream
	// .of(Arguments.of(Values.value(list), Named.<VerificationLogic<Object>>of("verify
	// returns List",
	// supplier -> assertThat(supplier.get()).isEqualTo(list)))));
	//
	// var mapStream = Stream.of(Map.of("k0", "v0", "k1", "k2"))
	// .flatMap(map -> Stream
	// .of(Arguments.of(Values.value(map), Named.<VerificationLogic<Object>>of("verify
	// returns Map",
	// supplier -> assertThat(supplier.get()).isEqualTo(map)))));
	//
	// var pointStream = Stream.of(Values.point(0, 1, 2))
	// .flatMap(point -> Stream
	// .of(Arguments.of(Values.value(point), Named.<VerificationLogic<Object>>of("verify
	// returns Point",
	// supplier -> assertThat(supplier.get()).isEqualTo(point.asPoint())))));
	//
	// var dateStream = Stream.of(LocalDate.now())
	// .flatMap(date -> Stream
	// .of(Arguments.of(Values.value(date), Named.<VerificationLogic<Object>>of("verify
	// returns LocalDate",
	// supplier -> assertThat(supplier.get()).isEqualTo(date)))));
	//
	// var timeStream = Stream.of(OffsetTime.now())
	// .flatMap(time -> Stream.of(Arguments.of(Values.value(time),
	// Named.<VerificationLogic<Object>>of(
	// "verify returns OffsetTime", supplier ->
	// assertThat(supplier.get()).isEqualTo(time)))));
	//
	// var localTimeStream = Stream.of(LocalTime.now())
	// .flatMap(time -> Stream
	// .of(Arguments.of(Values.value(time), Named.<VerificationLogic<Object>>of("verify
	// returns LocalTime",
	...
	// .flatMap(time -> Stream.of(Arguments.of(Values.value(time),
	// Named.<VerificationLogic<Object>>of(
	// "verify returns LocalDateTime", supplier ->
	// assertThat(supplier.get()).isEqualTo(time)))));
	//
	// var dateTimeStream = Stream.of(ZonedDateTime.now())
	// .flatMap(time -> Stream.of(Arguments.of(Values.value(time),
	// Named.<VerificationLogic<Object>>of(
	// "verify returns ZonedDateTime", supplier ->
	// assertThat(supplier.get()).isEqualTo(time)))));
	//
	// var durationStream = Stream.of(Values.isoDuration(Long.MAX_VALUE, Long.MAX_VALUE,
	// Long.MAX_VALUE, 0))
	// .flatMap(durationValue -> Stream
	// .of(Arguments.of(durationValue, Named.<VerificationLogic<Object>>of("verify returns
	// IsoDuration",
	// supplier ->
	// assertThat(supplier.get()).isEqualTo(durationValue.asIsoDuration())))));
	//
	// return switch (type) {
	...
	// // when & then
	// assertThatThrownBy(() ->
	// this.resultSet.wasNull()).isInstanceOf(SQLException.class);
	// }
	//
	// @Test
	...
	// return Stream.of(Values.value((Object) null), Values.value(1), Values.value(false),
	// Values.value("value"),
	// Values.value(0.5));
	// }
	//
	...
	// else {
	// assertThatThrownBy(() ->
	// this.resultSet.unwrap(cls)).isInstanceOf(SQLException.class);
	// }
	// }
	//
	// @ParameterizedTest
	...
	// return Stream.of(Arguments.of(ResultSetImpl.class, true),
	// Arguments.of(ResultSet.class, true),
	...
	// else {
	// assertThatThrownBy(() ->
	// this.resultSet.findColumn(label)).isInstanceOf(SQLException.class);
	// }
	// }
	//
	// @Test
	...
	// }
	//
	// private static Stream<Arguments> mapArgumentToBothIndexAndLabelAccess(Arguments
	// arguments) {
	// return Stream.of(Arguments.of(Stream.concat(Arrays.stream(arguments.get()),
	// Stream.of(true)).toArray()),
	// Arguments.of(Stream.concat(Arrays.stream(arguments.get()),
	// Stream.of(false)).toArray()));
	// }
	//
	// @ParameterizedTest
	// @MethodSource("shouldTruncateOnGetStringArgs")
	// void shouldTruncateOnGetString(Value value, int maxFieldSize,
	// VerificationLogic<String> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	...
	// void shouldTruncateOnGetObject(Value value, int maxFieldSize,
	// VerificationLogic<Object> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, maxFieldSize);
	// this.resultSet.next();
	...
	// void shouldTruncateOnGetBytes(Value value, int maxFieldSize,
	// VerificationLogic<byte[]> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, maxFieldSize);
	// this.resultSet.next();
	...
	// void shouldTruncateBytesOnGetBytes(Value value, int maxFieldSize,
	// VerificationLogic<Object> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, maxFieldSize);
	...
	// void shouldTruncateOnGetAsciiStream(Value value, int maxFieldSize,
	// VerificationLogic<InputStream> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, maxFieldSize);
	...
	// VerificationLogic<InputStream> verificationLogic, boolean indexAccess) throws
	// SQLException {
	// // given
	// this.resultSet = setupWithValue(value, maxFieldSize);
	// this.resultSet.next();
	...
	// void shouldTruncateOnGetCharacterStream(Value value, int maxFieldSize,
	// VerificationLogic<Reader> verificationLogic,
	// boolean indexAccess) throws SQLException {
	// // given
	// this.resultSet = setupWithValue(value, maxFieldSize);
	// this.resultSet.next();
	...
	// resultSet.next();
	// assertThatExceptionOfType(SQLException.class).isThrownBy(() ->
	// resultSet.getObject(1, Float.class))
	// .withMessage(
	// "org.neo4j.jdbc.values.UncoercibleException: Cannot coerce java.lang.String to
	// java.lang.Float");
	// }
	// }
	//
	...
	// return (name.startsWith("update") && !"updateRow".equals(name)) ||
	// name.matches("row.*ed");
	// });
	// var rowUpdates = testSupplier
	// .apply(method -> Set
	// .of("beforeFirst", "first", "last", "getRow", "absolute", "relative", "previous",
	// "moveToCurrentRow",
	// "afterLast")
	// .contains(method.getName()));
	// var positional = testSupplier.apply(method -> Set
	// .of("insertRow", "updateRow", "deleteRow", "refreshRow", "cancelRowUpdates",
	// "moveToInsertRow")
	// .contains(method.getName()));
	// var getters = testSupplier.apply(method -> Set
	// .of("getRef", "getBlob", "getClob", "getNClob", "getSQLXML", "getNString",
	// "getNCharacterStream",
	...
	// }
	//
	// private static Function<Predicate<Method>, Stream<DynamicTest>>
	// generateTestsForUnsupportedMethods(
	// ResultSet resultSet) {
	...
	// var name = method.getName();
	// var args =
	// Arrays.stream(method.getParameterTypes()).map(ResultSetImplTests::getDefaultValue).toArray();
	...
	//
	// return new ResultSetImpl(statement, mock(Neo4jTransaction.class), runResponse,
	// pullResponse, 1000, 0, 0);
	// }
	//
	// private ResultSet setupWithValue(Value expectedValue, int maxFieldSize) throws
	// SQLException {
	// var statement = mock(StatementImpl.class);
	// var runResponse = mock(RunResponse.class);
	//
