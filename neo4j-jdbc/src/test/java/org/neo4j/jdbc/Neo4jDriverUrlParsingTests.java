...
class Neo4jDriverUrlParsingTests {
	...
	// given(this.boltConnectionProvider.connect(any(), any(), any(), any(), any(), any(),
	// anyInt()))
	...
	// .connect(eq(new BoltServerAddress(host, port)), any(), any(), any(), any(), any(),
	// anyInt());
	// }
	//
	// @Test
	...
	// driver.connect(url, props);
	// then(this.boltConnectionProvider).should()
	// .connect(eq(new BoltServerAddress("host", DEFAULT_BOLT_PORT)), any(),
	// eq("database"), any(), any(), any(),
	// anyInt());
	// }
	//
	// @Test
	...
	// driver.connect(url, props);
	// then(this.boltConnectionProvider).should()
	// .connect(eq(new BoltServerAddress("host", DEFAULT_BOLT_PORT)), any(), eq("neo4j"),
	// any(), any(), any(),
	// anyInt());
	// }
	//
	...
	//
	// then(this.boltConnectionProvider).should()
	// .connect(eq(new BoltServerAddress("host", DEFAULT_BOLT_PORT)), any(), any(),
	// eq(expectedAuthToken), any(),
	// any(), anyInt());
	// }
	//
	// @Test
	...
	//
	// then(this.boltConnectionProvider).should()
	// .connect(eq(new BoltServerAddress("host", 1000)), any(), any(),
	...
	//
	// then(this.boltConnectionProvider).should()
	// .connect(eq(new BoltServerAddress("host", 1000)), any(), eq("database"),
	// eq(expectedAuthToken), any(),
	// any(), anyInt());
	// }
	//
	...
	// then(this.boltConnectionProvider).should()
	// .connect(eq(new BoltServerAddress("host", DEFAULT_BOLT_PORT)), any(),
	// eq("database"), eq(expectedAuthToken),
	// any(), any(), anyInt());
	// }
	//
	// @Test
