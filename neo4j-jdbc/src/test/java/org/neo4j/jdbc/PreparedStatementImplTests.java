...
class PreparedStatementImplTests {
	...
	void shouldExecuteQuery() throws SQLException {
		...
		this.statement = newStatement(mock(ExtendedNeo4jConnection.class), transactionSupplier, query);
	...
	private static PreparedStatementImpl newStatement(ExtendedNeo4jConnection connection,
