...
class PreparedStatementImplTests {
	...
	// textBlock = """
	// MATCH statement RETURN same WHERE thereAreNoPlaceholders|MATCH statement RETURN
	// same WHERE thereAreNoPlaceholders
	// MATCH statement RETURN same WHERE thereIsAPlaceholder = ?|MATCH statement RETURN
	// same WHERE thereIsAPlaceholder = $1
	// MATCH statement RETURN same WHERE thereIsAPlaceholder = ? AND another = ?|MATCH
	// statement RETURN same WHERE thereIsAPlaceholder = $1 AND another = $2
	// MATCH statement RETURN same WHERE thisIs = "a string ?" AND thereIsAPlaceholder = ?
	// AND another = ? AND notInString = "shall I replace this?"|MATCH statement RETURN
	// same WHERE thisIs = "a string ?" AND thereIsAPlaceholder = $1 AND another = $2 AND
	// notInString = "shall I replace this?"
	// MATCH statement RETURN same WHERE thereIsAPlaceholder = ? <NL>AND newLinePar =
	// ?|MATCH statement RETURN same WHERE thereIsAPlaceholder = $1 <NL>AND newLinePar =
	// $2
	// MATCH statement RETURN same WHERE thisIs = "a string ?"<NL>AND thereIsAPlaceholder
	// = ?<NL>AND another = ?|MATCH statement RETURN same WHERE thisIs = "a string
	// ?"<NL>AND thereIsAPlaceholder = $1<NL>AND another = $2
	// """)
	...
	// given(transactionSupplier.getTransaction(any())).willReturn(transaction);
	// given(transaction.runAndPull(query, Collections.emptyMap(),
	// StatementImpl.DEFAULT_FETCH_SIZE, 0))
	...
	// then(transaction).should().runAndPull(query, Collections.emptyMap(),
	// StatementImpl.DEFAULT_FETCH_SIZE, 0);
	...
	// return new PreparedStatementImpl(connection, transactionSupplier, null, null,
	// false, query);
	// }
	//
	// @Test
	...
	// given(transaction.runAndDiscard(query, Collections.emptyMap(), 0,
	// true)).willReturn(discardResponse);
	...
	// this.statement = newStatement(mock(Connection.class),
	// mock(Neo4jTransactionSupplier.class), "");
	...
	// this.statement = newStatement(mock(Connection.class),
	// mock(Neo4jTransactionSupplier.class), "query");
	// this.statement.close();
	// assertThat(this.statement.isClosed()).isTrue();
	// assertThatThrownBy(() ->
	// consumer.run(this.statement)).isInstanceOf(SQLException.class);
	// }
	//
	// static Stream<Arguments> getShouldThrowWhenClosedArgs() {
	// return Stream.of(Arguments.of((StatementMethodRunner) statement ->
	// statement.executeQuery("query")),
	// Arguments.of((StatementMethodRunner) statement ->
	...
	// Arguments.of((StatementMethodRunner) statement -> statement.setNull(0,
	// Types.NULL)),
	...
	// Arguments.of((StatementMethodRunner) statement -> statement.setShort(0, (short)
	// 0)),
	...
	// Arguments.of((StatementMethodRunner) statement -> statement.setString(0,
	// "string")),
	// Arguments.of((StatementMethodRunner) statement -> statement.setBytes(0, new
	// byte[0])),
	// Arguments.of((StatementMethodRunner) statement -> statement.setDate(0, new
	// Date(0))),
	// Arguments.of((StatementMethodRunner) statement -> statement.setTime(0, new
	// Time(0))),
	// Arguments.of((StatementMethodRunner) statement -> statement.setTimestamp(0, new
	// Timestamp(0))),
	...
	// new ByteArrayInputStream(new byte[0]), 0)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setObject(0,
	// "string")),
	// Arguments.of((StatementMethodRunner) statement -> statement.setCharacterStream(0,
	// new StringReader("string"), 0)),
	// Arguments
	// .of((StatementMethodRunner) statement -> statement.setDate(0, new Date(0),
	// Calendar.getInstance())),
	// Arguments
	// .of((StatementMethodRunner) statement -> statement.setTime(0, new Time(0),
	// Calendar.getInstance())),
	// Arguments.of((StatementMethodRunner) statement -> statement.setTimestamp(0, new
	// Timestamp(0),
	// Calendar.getInstance())),
	...
	// void shouldThrowUnsupported(StatementMethodRunner consumer, Class<? extends
	// SQLException> exceptionType) {
	// this.statement = newStatement(mock(Connection.class),
	// mock(Neo4jTransactionSupplier.class), "query");
	// assertThatThrownBy(() ->
	// consumer.run(this.statement)).isExactlyInstanceOf(exceptionType);
	// }
	//
	// static Stream<Arguments> getShouldThrowUnsupportedArgs() {
	// return Stream.of(Arguments.of((StatementMethodRunner) Statement::cancel,
	...
	// SQLException.class),
	// Arguments.of(
	// (StatementMethodRunner) statement ->
	// statement.getMoreResults(Statement.CLOSE_CURRENT_RESULT),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) Statement::getGeneratedKeys,
	// SQLFeatureNotSupportedException.class),
	// // not currently supported
	// Arguments.of((StatementMethodRunner) statement -> statement.setObject(1, null,
	// Types.NULL),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setRef(1, null),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setBlob(1,
	// mock(Blob.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setClob(1,
	// mock(Clob.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setArray(1,
	// mock(Array.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setNull(1, Types.NULL,
	// "name"),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setURL(1,
	// mock(URL.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setRowId(1,
	// mock(RowId.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setNClob(1,
	// mock(NClob.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setClob(1,
	// mock(Reader.class), 0),
	...
	// mock(Reader.class), 0),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setSQLXML(1,
	// mock(SQLXML.class)),
	// SQLFeatureNotSupportedException.class),
	// Arguments.of((StatementMethodRunner) statement -> statement.setObject(1, null,
	// Types.NULL, 0),
	...
	// mock(Neo4jTransactionSupplier.class), "query");
	// assertThatThrownBy(() ->
	// consumer.run(this.statement)).isExactlyInstanceOf(SQLException.class);
	// }
	//
	...
	// new String[0])),
	// Arguments
	// .of((StatementMethodRunner) statement -> statement.execute("query",
	// Statement.NO_GENERATED_KEYS)),
	// Arguments.of((StatementMethodRunner) statement -> statement.execute("query", new
	// int[0])),
	// Arguments.of((StatementMethodRunner) statement -> statement.execute("query", new
	// String[0])),
	// Arguments.of((StatementMethodRunner) statement ->
	...
	// Statement.NO_GENERATED_KEYS)),
	// Arguments.of((StatementMethodRunner) statement ->
	// statement.executeLargeUpdate("query", new int[0])),
	// Arguments
	// .of((StatementMethodRunner) statement -> statement.executeLargeUpdate("query", new
	// String[0])));
	// }
	//
	// @ParameterizedTest
	...
	// return Stream.of(Arguments.of((StatementMethodRunner) statement ->
	// statement.setNull(0, Types.NULL)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setBoolean(0, true)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setByte(0, (byte) 0)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setShort(0, (short)
	// 0)),
	...
	// void shouldSetParameter(StatementMethodRunner parameterSettingRunner, Value
	// expectedValue) throws SQLException {
	// this.statement = newStatement(mock(Connection.class),
	// mock(Neo4jTransactionSupplier.class), "query");
	//
	...
	// Arguments.of((StatementMethodRunner) statement -> statement.setNull(1, Types.NULL),
	// Values.NULL),
	// Arguments.of((StatementMethodRunner) statement -> statement.setBoolean(1, true),
	// Values.value(true)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setBoolean(1, false),
	// Values.value(false)),
	...
	// Arguments.of((StatementMethodRunner) statement -> statement.setInt(1, 1),
	// Values.value(1)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setLong(1, 1),
	// Values.value(1L)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setFloat(1, 1.0f),
	// Values.value(1.0f)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setDouble(1, 1.0),
	// Values.value(1.0)),
	// Arguments.of((StatementMethodRunner) statement -> statement.setString(1, "string"),
	// Values.value("string")),
	// Arguments.of((StatementMethodRunner) statement -> statement.setBytes(1, new byte[]
	// { 0, 1 }),
	...
	// Arguments.of(
	// (StatementMethodRunner) statement -> statement.setTime(1,
	// Time.valueOf(LocalTime.of(1, 1, 1))),
	...
	// Arguments.of((StatementMethodRunner) statement -> statement.setObject(1,
	// LocalDate.MAX),
	...
	// void shouldSetObjectParameter(Object object, Value expectedValue) throws
	// SQLException {
	// this.statement = newStatement(mock(Connection.class),
	// mock(Neo4jTransactionSupplier.class), "query");
	//
	...
	// return Stream.of(Arguments.of(null, Values.NULL), Arguments.of(true,
	// Values.value(true)),
	// Arguments.of(false, Values.value(false)), Arguments.of((byte) 1,
	// Values.value((byte) 1)),
	...
	// Arguments.of(1.0, Values.value(1.0)), Arguments.of("string",
	// Values.value("string")),
	// Arguments.of(new byte[] { 0, 1 }, Values.value(new byte[] { 0, 1 })),
	// Arguments.of(Date.valueOf(LocalDate.of(2000, 1, 1)),
	// Values.value(LocalDate.of(2000, 1, 1))),
	// Arguments.of(Time.valueOf(LocalTime.of(1, 1, 1)), Values.value(LocalTime.of(1, 1,
	// 1))),
	...
	// else {
	// assertThatThrownBy(() ->
	// this.statement.unwrap(cls)).isInstanceOf(SQLException.class);
	// }
	// }
	//
	// @ParameterizedTest
	...
	// return Stream.of(Arguments.of(PreparedStatementImpl.class, true),
	// Arguments.of(PreparedStatement.class, true),
