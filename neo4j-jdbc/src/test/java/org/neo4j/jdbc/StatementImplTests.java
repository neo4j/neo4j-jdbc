...
class StatementImplTests {
	...
	//
	// static StatementImpl newStatement(Connection connection, Neo4jTransactionSupplier
	// transactionSupplier) {
	// return new StatementImpl(connection, transactionSupplier, UnaryOperator.identity(),
	// null);
	// }
	//
	// @Test
	...
	// SQLFeatureNotSupportedException.class),
	// Arguments.of(
	// (StatementMethodRunner) statement -> statement.execute("query",
	...
	// return Stream.of(Arguments.of(StatementImpl.class, true),
	// Arguments.of(Statement.class, true),
	...
	// assertThat(this.statement.getFetchSize()).isEqualTo((fetchSize == 0) ? 1000 :
	// fetchSize);
	// }
	//
	// @Test
	...
	// """;
	//
	// return Stream.of(Arguments.of("/*+ NEO4J FORCE_CYPHER */ MATCH (n) RETURN n",
	// true),
