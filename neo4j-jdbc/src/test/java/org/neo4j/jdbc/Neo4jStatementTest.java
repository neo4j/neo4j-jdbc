 ...
 * @since 3.0.0
 */
public class Neo4jStatementTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		Neo4jStatement statement = mock(Neo4jStatement.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(statement.isWrapperFor(Neo4jStatement.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(statement.isWrapperFor(Neo4jParameterMetaData.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(statement.unwrap(Neo4jStatement.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		statement.unwrap(Neo4jResultSet.class);
	}
}
