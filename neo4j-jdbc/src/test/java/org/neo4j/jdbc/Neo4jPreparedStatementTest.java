 ...
 * @since 3.0.0
 */
public class Neo4jPreparedStatementTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		Neo4jPreparedStatement preparedStatement = mock(Neo4jPreparedStatement.class, Mockito.CALLS_REAL_METHODS);

		assertTrue(preparedStatement.isWrapperFor(Neo4jPreparedStatement.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(preparedStatement.isWrapperFor(Neo4jResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(preparedStatement.unwrap(Neo4jPreparedStatement.class));
	...
	@Test public void unwrapShouldThrowException() throws SQLException {
		...
		preparedStatement.unwrap(Neo4jResultSet.class);
	}
	...
	@Test public void addBatchShouldThrowException() throws SQLException {
		...
		Neo4jPreparedStatement stmt = Mockito.mock(Neo4jPreparedStatement.class, Mockito.CALLS_REAL_METHODS);
