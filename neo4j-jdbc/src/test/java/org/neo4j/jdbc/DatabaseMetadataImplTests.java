...
class DatabaseMetadataImplTests {
	...
	// metaData.getProcedures(null, "NotNull", null));
	// }
	//
	// @Test
	// void getDriverName() {
	...
	// var databaseMetadata = newDatabaseMetadata();
	// assertThatExceptionOfType(SQLException.class)
	// .isThrownBy(() -> databaseMetadata.getPrimaryKeys(null, "notPublic",
	// "someTableDoesNotMatter"));
	// }
	//
	// @Test
	// void getImportedKeysShouldReturnEmptyResultSet() throws SQLException {
	// var databaseMetadata = newDatabaseMetadata();
	// try (var tableTypes = databaseMetadata.getImportedKeys(null, "public",
	// "someTableDoesNotMatter")) {
	...
	// var databaseMetadata = newDatabaseMetadata();
	// assertThatExceptionOfType(SQLException.class)
	// .isThrownBy(() -> databaseMetadata.getImportedKeys(null, "notPublic",
	// "someTableDoesNotMatter"));
	// }
	//
	// @Test
	...
	// var databaseMetadata = newDatabaseMetadata();
	// try (var tableTypes = databaseMetadata.getExportedKeys(null, "public",
	// "someTableDoesNotMatter")) {
	// assertThat(tableTypes.next()).isFalse();
	// }
	// }
	...
	// var databaseMetadata = newDatabaseMetadata();
	// assertThatExceptionOfType(SQLException.class)
	// .isThrownBy(() -> databaseMetadata.getExportedKeys(null, "notPublic",
	// "someTableDoesNotMatter"));
	// }
	//
	// @Test
	...
	// var databaseMetadata = newDatabaseMetadata();
	// assertThatExceptionOfType(SQLException.class).isThrownBy(() ->
	// databaseMetadata.getFunctionColumns(null,
	...
	// .withMessage(
	// "Catalog 'NotNull' is not available in this Neo4j instance, please leave blank or
	// specify the current database name");
	//
	// assertThatExceptionOfType(SQLException.class)
	// .isThrownBy(() -> connection.getMetaData().getTables("NotNull", "public", null,
	// null))
	// .withMessage(
	// "Catalog 'NotNull' is not available in this Neo4j instance, please leave blank or
	// specify the current database name");
	...
	// return new DatabaseMetadataImpl(connection, (s) -> mock(Neo4jTransaction.class),
	// false, 1000);
	// }
