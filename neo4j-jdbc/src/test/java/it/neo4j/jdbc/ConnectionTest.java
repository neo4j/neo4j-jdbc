...
public class ConnectionTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		...
		assertTrue(connection.isWrapperFor(it.neo4j.jdbc.Connection.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(connection.isWrapperFor(it.neo4j.jdbc.Statement.class));
		assertFalse(connection.isWrapperFor(java.sql.Driver.class));
		assertFalse(connection.isWrapperFor(it.neo4j.jdbc.ResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(connection.unwrap(it.neo4j.jdbc.Connection.class));
