...
public class CallableStatementTest {
	...
	@Test public void isWrapperForShouldReturnTrue() throws SQLException {
		...
		assertTrue(callableStatement.isWrapperFor(it.neo4j.jdbc.CallableStatement.class));
	...
	@Test public void isWrapperForShouldReturnFalse() throws SQLException {
		...
		assertFalse(callableStatement.isWrapperFor(it.neo4j.jdbc.ResultSet.class));
	...
	@Test public void unwrapShouldReturnCorrectClass() throws SQLException {
		...
		assertNotNull(callableStatement.unwrap(it.neo4j.jdbc.CallableStatement.class));
