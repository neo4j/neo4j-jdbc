...
public class InternalStatementResult implements StatementResult
{
    ...
    private StreamCollector newPullAllResponseCollector( Statement statement )
    {
        ...
        return new StreamCollector.NoOperationStreamCollector()
        {
            ...
            {
            	//try { String x = null; x.length(); } catch (Exception e) { System.err.println("statementType"); e.printStackTrace(); }
            ...
            {
            	//try { String x = null; x.length(); } catch (Exception e) { System.err.println("statementStatistics"); e.printStackTrace(); }
