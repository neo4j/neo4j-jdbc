...
public class SocketResponseHandler implements MessageHandler
{
    ...
    {
    	//try { String x = null; x.length(); } catch (Exception e) { System.err.println("handleSuccessMessage"); System.err.println(meta.get( "stats" )); System.err.println( meta.get( "type" )); e.printStackTrace(); }
        StreamCollector collector = collectors.remove();
