...
def main(token, tag_name, file_names):
    ...
    response = requests.post("https://api.github.com/repos/neo4j-contrib/neo4j-jdbc/releases",
    ...
    for file_name in file_names:
        with open(file_name, "rb") as file_name_handle:
            upload_url = "https://uploads.github.com/repos/neo4j-contrib/neo4j-jdbc/releases/{release_id}/assets?name={file_name}".format(
