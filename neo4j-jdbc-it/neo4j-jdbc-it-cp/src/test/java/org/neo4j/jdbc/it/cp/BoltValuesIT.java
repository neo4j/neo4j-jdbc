...
class BoltValuesIT extends IntegrationTestBase {
	...
	static Stream<Arguments> arrayVectorShouldBeReflected() {
		return Stream.of(Arguments.of(Vector.int8(new byte[] { 127 }), new byte[] { 127 }),
				Arguments.of(Vector.int16(new short[] { Short.MAX_VALUE }), new short[] { Short.MAX_VALUE }),
				Arguments.of(Vector.int32(new int[] { Integer.MAX_VALUE }), new int[] { Integer.MAX_VALUE }),
				Arguments.of(Vector.int64(new long[] { Long.MAX_VALUE }), new long[] { Long.MAX_VALUE }),
				Arguments.of(Vector.float32(new float[] { 1.23F }), new float[] { 1.23F }),
				Arguments.of(Vector.float64(new double[] { 1.23 }), new double[] { 1.23 }));
	}
